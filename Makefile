...
#CFLAGS= -O
CFLAGS= -O -nostdlib -nostdinc -nostartfiles -nodefaultlibs -fno-builtin -I`pwd` -m32 -I../../libc/include/
# Generally, we recommend defining any configuration symbols in jconfig.h,
# NOT via -D switches here.

# Link-time cc options:
LDFLAGS= -Ttext=40000000 --entry=start_main -melf_i386
